...
if(isset($_POST['post'])){
    ...
    if(!empty($image_03)){
        if($image_03_size > 2000000){
           ...
           move_uploaded_file($image_03_tmp_name, $image_03_folder); //transport the image from the temp  
        }                                                            //location to the new directory
    }else{
        $rename_image_03 = '';
    }
    ...
    if($image_01_size > 2000000){
        $warning_msg[] = 'image size exceeded!';
     }else{
        $insert_property = $conn->prepare("INSERT INTO `property`(id, user_id, property_name, address, price, type, offer, status, furnished, floor, deposit, bedroom, bathroom, balcony, carpet, age, total_floors, ownership, loan, lift, security_guard, play_ground, garden, water_supply, power_backup, parking_area, gym, shopping_mall, hospital, school, market_area, image_01, image_02, image_03, image_04, image_05, description) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"); 
        $insert_property->execute([$id, $user_id, $property_name, $address, $price, $type, $offer, $status, $furnished, $floor, $deposite, $bedroom, $bathroom, $balcony, $carpet, $age, $total_floors, $ownership, $loan, $lift, $security_guard, $play_ground, $garden, $water_supply, $power_backup, $parking_area, $gym, $shopping_mall, $hospital, $school, $market_area, $rename_image_01, $rename_image_02, $rename_image_03, $rename_image_04, $rename_image_05, $description]);
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="flex">
            ...
            <div class="box">
                ...
                <input type="number" name="price" required min="0" max="9999999999" 
                maxlength="10" placeholder="Enter property price" class="input">
            </div>
            <div class="box">
                <p>Deposit amount <span>*</span></p>
                <input type="number" name="deposit" required min="0" max="9999999999" 
                maxlength="10" placeholder="Down payment" class="input">
            </div>
            <div class="box">
                <p>Property address <span>*</span></p>
                <input type="text" name="address" required maxlength="100" 
                placeholder="Enter property address" class="input">
            </div>
            <div class="box">
            ...
            <div class="box">
                <p>Furnished details <span>*</span></p>
            ...
            <div class="box">
                ...
                <select name="floor" required class="input">
            ...
            <div class="box">
                ...
                <input type="number" name="carpet" required min="1" max="9999999999" 
                maxlength="10" placeholder="how many sqft?" class="input">
            </div>
            <div class="box">
                <p>Property age <span>*</span></p>
                <input type="number" name="age" required min="0" max="99" 
                maxlength="2" placeholder="How old is the property?" class="input">
            </div>
            <div class="box">
                <p>Total floors <span>*</span></p>
                <input type="number" name="total_floors" required min="0" max="99" 
                maxlength="2" placeholder="How many floors available?" class="input">
            </div>
            <!-- <div class="box">
                <p>Property ownership <span>*</span></p>
                <input type="number" name="ownership" required min="0" max="99" 
                maxlength="2" placeholder="Ownership details?" class="input">
            </div> -->
            <div class="box">
                <p>Property ownership <span>*</span></p>
        ...
        <div class="box">
            ...
            <textarea name="description" maxlength="1000" class="input" required cols="30" 
            rows="10" placeholder="Write about the property..."></textarea>
        </div>
        ...
        <input type="submit" value="post property" class="btn-post" name="post">
    </form>
